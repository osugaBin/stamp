...
- **🖼️ 印章管理**: 支持上传各种格式的印章图片（PNG、JPG、GIF 等），白底照片即可
- **🎯 精确定位**: 点击页面任意位置添加印章，拖拽调整位置
...
- **🎨 现代化 UI**: 美观的渐变色界面设计
- **⚡ 边界检查**: 自动防止印章超出页面边界
- **🖱️ 智能交互**: 点击空白区域添加印章，点击印章进行选择和拖拽
- **✨ 流畅体验**: 印章拖拽时的视觉反馈和动画效果
...
- **智能点击添加**: 直接点击 PDF 预览区域的任意位置即可添加印章
- **按钮添加**: 调整印章大小后，点击"添加印章到当前页"按钮在页面中央添加印章
- **防重复添加**: 点击已有印章时会选中该印章而不是重复添加

### 3. 编辑印章

- **自由拖拽**: 鼠标悬停印章时显示移动光标，拖拽印章到目标位置
- **视觉反馈**: 拖拽时印章会有透明度和缩放效果，提供流畅的交互体验
- **智能选择**: 点击印章自动选中，点击空白区域添加新印章
- **快速删除**: 选中印章后点击"删除选中印章"按钮
- **批量清空**: 点击"清空当前页"按钮删除当前页所有印章
...
- **样式**: CSS3 (Flexbox, Grid, 渐变色, 动画效果)
- **交互体验**: 原生 DOM 事件处理，拖拽 API，视觉反馈
- **响应式**: CSS 媒体查询
- **部署**: GitHub Pages
